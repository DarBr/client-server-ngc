...
export class CustomReuseStrategy implements RouteReuseStrategy {
  ...
  shouldDetach(route: ActivatedRouteSnapshot): boolean {
    ...
    if (route.routeConfig!.path === 'login' || route.routeConfig!.path === '' || route.routeConfig!.path === 'transaktion-liste' || route.routeConfig!.path === 'kaufen' || route.routeConfig!.path === 'verrechnungskonto') {
      return false;
    }
